...
return [
    ...
    */
    ...
    'projects' => new App\Projects([
      new App\Project('ACOSS', 'slack', ['UEMA8DE8Y', 'UEN897F5K']),
      new App\Project('ADLER', 'slack', ['UEPH8SSJE', 'UEMUL8CFM']),
      new App\Project('CartoBio', 'slack', ['UEMV1JHGT', 'UENNM7ZB3']),
      new App\Project('CibNAV', 'slack', ['UEMUVJ0UB', 'UEVFULCJX']),
      new App\Project('DataJust', 'slack', ['UFP3Z5XT9', 'UEP1QMJ8G']),
      new App\Project('DataReg', 'slack', ['UEP0XENPK', 'UEMAW8E64']),
      new App\Project('EIG Link', 'slack', ['U85PEEN9H', 'U85SM3C3E']),
      new App\Project('EIG Node', 'slack', ['U80K1J3NE', 'U83PGP6TW']),
      new App\Project('Explo Code', 'slack', ['UEP68HULF', 'UEN3EERS6']),
      new App\Project('IA Flash', 'slack', ['UEMUZ0REX', 'UFETC0RPW']),
