...
class ReportTest extends TestCase
{
    ...
    public function testReportCanBeFilled()
    {
        $tests = [
            ...
            [Carbon::create(2019, 3, 8, 15), true],
            [Carbon::create(2019, 3, 8, 15, 4), true],
            [Carbon::create(2019, 3, 8, 15, 5), false],
    ...
    public function testlatestPublishedWeek()
    {
        $tests = [
            ...
            [Carbon::create(2019, 3, 8, 15, 4), '2019-09'],
            [Carbon::create(2019, 3, 8, 15, 5), '2019-10'],
    ...
    public function testScopePublished()
    {
        ...
        $tests = [
            ...
            [Carbon::create(2019, 3, 8, 15, 4), [$report->id]],
            [Carbon::create(2019, 3, 8, 15, 5), [$report->id, $report2->id]],
